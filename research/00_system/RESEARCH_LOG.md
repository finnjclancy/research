...
## 2026-06-29 — Big Moves study (all 16) + fresh theses

**Added:** [`../07_big_moves/`](../07_big_moves/) — one file per name cataloguing the **largest single-day moves and the researched driver of each**, plus **fresh bull/bear/variant theses**. A synthesis [README](../07_big_moves/README.md) ranks the catalyst taxonomy (binary readouts > guidance cuts > M&A > systemic/contagion > political > macro-tape > commodity/regulatory) and the meta-lessons (expectations-vs-reality drives the biggest moves; beats can sell off; positioning amplifies; some names move on the macro tape not their own news). Built as the **comparable bank** for the news→range reflex + recap calibration. Cross-linked from the index. Documented episodes include: ASML −16% (Oct-24 bookings/guide), −11% (Jul-25 "cannot confirm"); Novo −18%+ (CagriSema, biggest in its history), −16% (REDEFINE 4); AMD +24% (OpenAI), −9% (Apr-24 in-line); Amazon −14% (2022 first loss), −8.3% (Aug-24); banks Mar-23 SVB/CS −7%+ and Jun-24 French-election −8–14%; Unilever +12% (Kraft Heinz), −10% (GSK); Zalando −17% (2022 profit warning); Embracer −40% (2023 Saudi/Savvy collapse); Carlsberg (Russia 2015/2022–23); Melexis (2019 auto downturn −14%).
